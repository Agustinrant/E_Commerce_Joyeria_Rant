...
-- Area contable
CREATE USER 'contabilidad'@'localhost' IDENTIFIED BY 'password_contabilidad';

-- Area atencion al cliente
CREATE USER 'soporte_cliente'@'localhost' IDENTIFIED BY 'password_soporte';

-- Area depositos
CREATE USER 'area_envios'@'localhost' IDENTIFIED BY 'password_envios';
...
-- Permisos area contable
GRANT SELECT ON joyeríaecommerce.pedido TO 'contabilidad'@'localhost';
GRANT SELECT ON joyeríaecommerce.detalle_pedido TO 'contabilidad'@'localhost';
GRANT SELECT ON joyeríaecommerce.ingresos_por_ciudad TO 'contabilidad'@'localhost';

SHOW GRANTS FOR 'contabilidad'@'localhost';

-- Permisos area soporte al cliente
GRANT SELECT ON joyeríaecommerce.cliente TO 'soporte_cliente'@'localhost';
GRANT SELECT ON joyeríaecommerce.cliente_cambios TO 'soporte_cliente'@'localhost';
GRANT SELECT ON joyeríaecommerce.vista_clientes TO 'soporte_cliente'@'localhost';
GRANT SELECT ON joyeríaecommerce.clientes_por_año TO 'soporte_cliente'@'localhost';

SHOW GRANTS FOR 'soporte_cliente'@'localhost';

-- Permisos area envios
GRANT SELECT ON joyeríaecommerce.direccion TO 'area_envios'@'localhost';
GRANT SELECT ON joyeríaecommerce.cliente TO 'area_envios'@'localhost';

SHOW GRANTS FOR 'area_envios'@'localhost';
...
-- Ver configuracion para exportar
